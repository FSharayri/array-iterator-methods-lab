...
// Enter your solution code here:
 veryOldInventors = inventors.filter( (el)=>{
...
// Enter your solution code here:
inventorNames = inventors.map((el)=>{
    return { 'first' : el.first, 'last' : el.last  }
...
commentById = comments.find(el=> el.id===823423)
...
idx = comments.findIndex(el=>el.id ===123523)
...
totalYearsLived = inventors.reduce((total,el)=>total+el.passed- el.year,0)
